...
static const t_data g_datas[] = {
	...
	(t_data){.name = "Microphone", .data_type = BINARY, .binary = 0},
	(t_data){.name = "Spectro_current", .data_type = INTEGER, .int_data = 32767, .int_delta = 32767},
	(t_data){.name = "Organ_current", .data_type = INTEGER, .int_data = 127, .int_delta = 127},
	(t_data){.name = "Vin_current", .data_type = INTEGER, .int_data = 32767, .int_delta = 32767},
	(t_data){.name = "Q7_current", .data_type = INTEGER, .int_data = 127, .int_delta = 127},
	(t_data){.name = "5v_current", .data_type = INTEGER, .int_data = 127, .int_delta = 127},
	(t_data){.name = "3.3v_current", .data_type = INTEGER, .int_data = 127, .int_delta = 127},
	(t_data){.name = "Motor_current", .data_type = INTEGER, .int_data = 32767, .int_delta = 32767},
	(t_data){.name = "Carousel_state", .data_type = INTEGER, .int_data = 59, .int_delta = 59},
	(t_data){.name = "Lid_state", .data_type = INTEGER, .int_data = 26, .int_delta = 26},
...
static const t_data *g_all_data[] = {
	(t_data[]){
		...
		(t_data){.name = "Temperature_1", .offset = offsetof(t_sensors, temperature_1), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_2", .offset = offsetof(t_sensors, temperature_2), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_3", .offset = offsetof(t_sensors, temperature_3), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_4", .offset = offsetof(t_sensors, temperature_4), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_5", .offset = offsetof(t_sensors, temperature_5), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_6", .offset = offsetof(t_sensors, temperature_6), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_7", .offset = offsetof(t_sensors, temperature_7), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_8", .offset = offsetof(t_sensors, temperature_8), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_9", .offset = offsetof(t_sensors, temperature_9), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
	...
	(t_data[]){
		...
		(t_data){.name = "Photodiode_5", .offset = offsetof(t_sensors, photodiode_5), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Photodiode_6", .offset = offsetof(t_sensors, photodiode_6), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_1", .offset = offsetof(t_sensors, temperature_1), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_2", .offset = offsetof(t_sensors, temperature_2), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_3", .offset = offsetof(t_sensors, temperature_3), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
		(t_data){.name = "Temperature_4", .offset = offsetof(t_sensors, temperature_4), .data_type = INTEGER, .int_data = 2048, .int_delta = 2048},
